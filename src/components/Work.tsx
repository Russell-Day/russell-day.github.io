...
const projects = [
  ...
  },
  {
    ...
    description: "05 | DATA MANIPULATION",
    image: blueprints,
  },
];
  ...
  return (
    <section id="work" className="py-16">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold mb-4">Hi, I'm Russell.</h1>
        <p className="text-xl text-gray-700">
          Data science student at the University of Michigan. Currently coding
          away for{" "}
      ...
      <h2 className="text-xl text-gray-700 mb-4">WORK</h2>
