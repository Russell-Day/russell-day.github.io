    ...
    <section id="cv" className="py-16">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p>
            266 Woodberry Drive | Bloomfield Hills, MI 48304 | 617-961-2251 |{" "}
            <a href="mailto:russday@umich.edu" className="text-blue-600">
              russday@umich.edu
            </a>
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-500">
                  ...
                  Blueprints for Pangaea, Honors College
                </p>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Weighted GPA: 4.1, Dean’s List and Honor Roll all eligible
                  semesters
                </p>
                <p className="text-gray-500">
                  Activities and societies: Global Outreach Club President,
                  Wellness Team Chairperson, Debate Team Leadership, Robotics
                  Team, Varsity Cross Country, Varsity Track and Field,
                  Intramural Boxing
                </p>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  High School Dual Enrollment, Course: 1500 Intro to Programming
                  (Java), Grade: A
                </p>
                <p className="text-gray-500">Dates: 06/2022 - 08/2022</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600">
                  Animal research, collecting/analyzing data on the effect of
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Focused on: Gender Diversity in Orthopedic Medicine and
              ...
              <div>
                ...
                <p className="text-gray-500">Dates: 05/2023 - 08/2023</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-500">Date: 09/25/2023</p>
              </div>
              <div>
                <a
                ...
                <p className="text-gray-500">Date: 07/06/2022</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600">
                  A 501(c)(3) not-for-profit medical surplus recovery
                  organization (MSRO) that provides sustainable solutions to
                  inefficient health care resource distribution
                </p>
                <p className="text-gray-600">
                  Ops Core Team: Manage operations and oversee medical supply
                  redistribution
                </p>
                <p className="text-gray-600">
                  App Design Team: Create robust database and utilize computer
                  vision for efficient inventorying
                </p>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Helped to organize every other month service projects during
                  the school year, including food distribution, neighborhood
                  clean ups, book drives, collectively served over 500 hours
                </p>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Responsible for organizing/leading activities such as teaching
                  Scratch and crafts. Led meal prep for 50+ people, applied
